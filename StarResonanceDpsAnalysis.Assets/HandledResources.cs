...
namespace StarResonanceDpsAnalysis.Assets
{
    public static class HandledResources
    {
        ...
        public const string HARMONU_OS_SANS_SC_BOLD_FONT_KEY = "HarmonyOS Sans SC Bold";
        ...
        {
            return FontLoader.LoadFontFromBytesAndCache(HARMONU_OS_SANS_SC_BOLD_FONT_KEY, Resources.HarmonyOS_Sans_SC_Bold, fontSize, fontStyle);
        }
